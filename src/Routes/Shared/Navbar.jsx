  ...
  return (
    <div className="navbar bg-base-100">
      ...
      <div className="navbar-end">
        {/* <Link className="btn"><FaCartPlus/><div className="badge badge-secondary">+99</div></Link> */}
        <button className="btn">
        <Link to="/dashboard/mycart"><FaCartPlus/></Link> 
  <div className="badge badge-secondary align-top">{cart?.length || 0}</div>
</button>
